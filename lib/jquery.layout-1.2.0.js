	...
	var cssW = function (e, outerWidth) {
		...
		if (!$.boxModel)
			...
			return outerWidth
				...
				- ($E.css("borderLeftStyle") == "none" ? 0 : cssNum($E, "borderLeftWidth"))
				- ($E.css("borderRightStyle") == "none" ? 0 : cssNum($E, "borderRightWidth"))
			;
	};
	var cssH = function (e, outerHeight) {
		...
		if (!$.boxModel)
			...
			return outerHeight
				...
				- ($E.css("borderTopStyle") == "none" ? 0 : cssNum($E, "borderTopWidth"))
				- ($E.css("borderBottomStyle") == "none" ? 0 : cssNum($E, "borderBottomWidth"))
			;
	};
